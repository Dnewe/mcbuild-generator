...
class VAE(nn.Module):
    def __init__(self, block_count, embed_dim=64, latent_channels=16) -> None:
        ...
        self.encoder = nn.Sequential(
            nn.Conv3d(embed_dim, 32, 3, 1, 1), nn.ReLU(),
            nn.Conv3d(32, 64, 3, 2, 1), nn.ReLU(),
            nn.Conv3d(64, 128, 3, 2, 1), nn.ReLU(),
        )
        ...
        self.decoder = nn.Sequential(
            nn.ConvTranspose3d(latent_channels, 128, 3, 1, 1), nn.ReLU(),
            nn.ConvTranspose3d(128, 64, 3, 2, 1, 1), nn.ReLU(),
            nn.ConvTranspose3d(64, 32, 3, 2, 1, 1), nn.ReLU(),
